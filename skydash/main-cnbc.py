    ...
    def get_articles(self, response):
        ...
        for page in range(1, int(self.pages)+1):
            ...
            for article in articles:
                ...
                cursor.execute(sql, (id_admin, kategori, id_status, title, published_time_WIB, content, image, href))
...
if __name__ == '__main__':
    ...
    #                 <a href="systemfiltering/" class="btn btn-outline-info btn-fw">Kembali</a>
    #                 <h3>Berhasil diaktifkan!</h3>
    #                 <p>Sistem telah berhasil di aktifkan dengan melalui proses srapping, filtering data, dan masuk ke database. Silahkan klik tombol kembali dan klk menu validasi untuk memvalidasi berita yang sudah tersimpan </p>
    #             </div>
    #         </div>
    #     </div>
    # </div>
